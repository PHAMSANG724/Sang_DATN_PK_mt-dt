...
namespace WebShop.Areas.Admin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(LinhKienDienTuContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> AdminLogin(LoginViewModel model, string returnUrl = null)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    //identity
                    //luuw seccion Makh
                    HttpContext.Session.SetString("AccountId", kh.MaTk.ToString());
                    ...
                    var userClaims = new List<Claim>
                    {
                        ...
                        new Claim("AccountId", kh.MaTk.ToString()),
                        new Claim("RoleId", kh.MaQuyen.ToString()),
                        new Claim(ClaimTypes.Role, kh.MaQuyenNavigation.TenQuyen)
                    };
